...
[![GoDoc](https://godoc.org/github.com/cfebs/geziyor?status.svg)](https://godoc.org/github.com/cfebs/geziyor)
[![report card](https://goreportcard.com/badge/github.com/cfebs/geziyor)](http://goreportcard.com/report/cfebs/geziyor)
[![Code Coverage](https://img.shields.io/codecov/c/github/cfebs/geziyor/master.svg)](https://codecov.io/github/cfebs/geziyor?branch=master)
...
See scraper [Options](https://godoc.org/github.com/cfebs/geziyor#Options) for all custom settings. 
...
See [tests](https://github.com/cfebs/geziyor/blob/master/geziyor_test.go) for more usage examples.

## Documentation

### Installation

    go get -u github.com/cfebs/geziyor
...
You can make requests using ```Geziyor``` [methods](https://godoc.org/github.com/cfebs/geziyor#Geziyor):
...
[Available exporters](https://godoc.org/github.com/cfebs/geziyor/export)
...
See [tests](https://github.com/cfebs/geziyor/blob/master/geziyor_test.go) for this benchmark function:

```bash
>> go test -run none -bench Requests -benchtime 10s
goos: darwin
goarch: amd64
pkg: github.com/cfebs/geziyor
BenchmarkRequests-8   	  200000	    108710 ns/op
PASS
ok  	github.com/cfebs/geziyor	22.861s
```
